...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.49109729;
    ...
    public static final TrajectoryAccelerationConstraint SHAKE_ACCEL_CONSTRAINT = getAccelerationConstraint(200);
