...
public class FieldConstants {
    ...
    public static Pose neutralLeftSpike = new Pose(44.5, 123, Math.toRadians(75));
    public static Pose neutralCenterSpike = new Pose(24.5, 129.75, Math.toRadians(0));
    public static Pose neutralRightSpike = new Pose(24, 119.75, Math.toRadians(0));
    ...
    public static Pose basket = new Pose(20, 120.5, Math.toRadians(315));
