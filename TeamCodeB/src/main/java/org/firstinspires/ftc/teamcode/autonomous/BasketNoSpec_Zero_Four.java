...
@Autonomous(name = "Basket No Specimen 0 + 4", group = "Basket")
public class BasketNoSpec_Zero_Four extends OpMode {
    ...
    private void buildPaths() {
        ...
        centerSampleScore = new Path(new BezierLine(
                ...
                new Point(blueAllianceBasket.getX()+9.5, blueAllianceBasket.getY()+4, Point.CARTESIAN)));
...
//                .build();
        ...
        leftSampleCycleChain = bot.follower.pathBuilder()
                .addPath(new BezierCurve(
                        ...
                        new Point(blueAllianceNeutralLeftSpike.getX()-36, blueAllianceNeutralLeftSpike.getY()-36, Point.CARTESIAN), // 15.5, 105.5
                        new Point(blueAllianceNeutralLeftSpike.getX()-9, blueAllianceNeutralLeftSpike.getY()-30, Point.CARTESIAN)  // 30.5, 107.5
                ))
                .setLinearHeadingInterpolation(Math.toRadians(-60), Math.toRadians(90))
                .addPath(new BezierLine(
                        new Point(blueAllianceNeutralLeftSpike.getX()-9, blueAllianceNeutralLeftSpike.getY()-30, Point.CARTESIAN), // 30.5, 107.5
                        new Point(blueAllianceNeutralLeftSpike.getX()-5, blueAllianceNeutralLeftSpike.getY()-17, Point.CARTESIAN)  // 33.5, 111.5
                ))
        ...
        switch(pathState) {
            ...
            case 9: // Stop the opmode
                ...
                if (pathTimer.getElapsedTimeSeconds() > 0.4) {
                    bot.verticalExtension.setTargetPosition(1300);
                }
                break;
        }
    }
